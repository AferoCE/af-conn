...
static char *sIgnorePrefixTable[] = {
    "+PBREADY"
};
...
{
    /* ignore some events */
    if (prv_prefix_table_find(line, sIgnorePrefixTable, ARRAY_SIZE(sIgnorePrefixTable)) >= 0) {
        return;
    }
